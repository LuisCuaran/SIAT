...
$editar = "UPDATE cliente SET nombre='$params->nombre', direccion='$params->direccion', telefono='$params->telefono', email='$params->email' WHERE id_cliente=$id"; // comentar para prueba
